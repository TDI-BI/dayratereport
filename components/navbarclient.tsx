    ...
    <div>
      ...
      <div className="sm:hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3 h-[62px]">
          ...
          {/* Logo island */}
          <div className="bg-tdi-blue shadow px-4 py-2 h-[36px] w-[106px] flex items-center justify-center overflow-hidden">
            <img
        ...
        {/* Mobile menu */}
        <div className={`fixed top-[62px] left-4 right-4 z-[75] bg-tdi-blue shadow transition-all duration-300 ease-in-out ${
          ...
          >
            <span className={`text-sm font-semibold uppercase tracking-tight select-none transition-colors duration-200 ${
          ...
          <form action={logout} onClick={() => setIsOpen(false)}>
            <button className="group flex flex-col w-full px-5 py-4 text-left">
              <span className="text-sm font-semibold uppercase tracking-tight text-secondary/60 group-hover:text-secondary select-none transition-colors duration-200">
                Logout
              </span>
              <div className="h-[2px] bg-secondary w-0 group-hover:w-full transition-all duration-300 ease-in-out mt-1" />
            </button>
          </form>
        </div>
      </div>
