            ...
            <form action={formAction}>
                <h1 className="formLine">
                    <p className="formIcon">
                        <Image priority src={names} alt="icon" />
                    </p>
                    <input
                ...
                <h1 className="formLine">
                    <p className="formIcon w-[48px]">
                        <Image priority src={boat} alt="icon" />
                    </p>
                    <select
                        className="w-[232px] h-[50px] formInput hoverLn hoverLnF"
                        name="crew"
                    >
                ...
                <h1 className="formLine">
                    <button>
                        <p className="w-[280px] btnh btn hoverbg">register</p>
                    </button>
                </h1>
