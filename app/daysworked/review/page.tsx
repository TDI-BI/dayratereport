    ...
    return (
        <main className="flex min-h-screen flex-col items-center px-5 py-5">
            ...
            <div
                    ...
                    <div
                        className={`rounded-md w-full ${saving ? 'max-w-[100%]' : 'max-w-[0%]'} h-[3px] bg-gradient-to-tr from-sky-300 to-indigo-500 overflow-hidden ease-in-out duration-500 delay-300`}/>
                </div>
