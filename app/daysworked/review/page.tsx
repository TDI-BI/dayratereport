    ...
    return (
        <main className="flex min-h-screen flex-col items-center">
                            ...
                            period.map((day) => (
                                ...
                                >
                                    ...
                                    <TableCell
                                        ...
                                        key={day + "ship"}
                                    >
                                        {vesselDict[day] ? vesselDict[day] : ""}
                                    </TableCell>
                                    <TableCell
                                        className="reportTxt"
                                        key={day + "job"}
                                    >
                                        {crewDict[day] ? crewDict[day] : ""}
                                    </TableCell>
                                </TableRow>
            ...
            <div className={pulled ? "report" : "report hidden"}>
                <div
                    className="w-[345px] pt-[10px] pb-[10px] rounded-2xl"
                    id="target"
                >
                    <div className="inline-flex flex-row">
                        <p className="w-[345px] text-center">
                            <input type="checkbox" id="affirm" />: I acknowledge
                            and certify that the information on this document is
                            true and accurate
                        </p>
                    </div>
                </div>
                ...
                <p
                    className={
                        "text-center " + (saving ? "savemsg1" : "savemsg0")
                    }
                >
                    {saving ? "preparing email..." : "sent"}
                </p>
            </div>
