...
export default function Home() {
    ...
    useEffect(() => {
        async function init() {
            ...
            if (authRes.status === 401) { router.push("/"); return; }
      ...
      <main className="flex justify-center px-5 bg-secondary min-h-screen">
          <div className="w-full max-w-[360px] py-8 flex flex-col gap-6">
              ...
              <div className="bg-tdi-blue p-3 shadow grid grid-cols-2 gap-3">
                  {period.map((day, i) => (
                    ...
                    >
                        ...
                        >
                            {/* Corner ticks */}
                            <span className="absolute top-0 left-0 h-[2px] w-0 bg-tdi-blue group-hover:w-3 transition-all duration-300 ease-in-out" />
                            <span className="absolute top-0 left-0 w-[2px] h-0 bg-tdi-blue group-hover:h-3 transition-all duration-300 ease-in-out" />
                            <span className="absolute bottom-0 right-0 h-[2px] w-0 bg-tdi-blue group-hover:w-3 transition-all duration-300 ease-in-out" />
                            <span className="absolute bottom-0 right-0 w-[2px] h-0 bg-tdi-blue group-hover:h-3 transition-all duration-300 ease-in-out" />
                  ...
                  <div className="flex items-center justify-center px-3">
                        <span className={`text-xs font-semibold uppercase tracking-tight transition-all duration-300 ease-in-out ${
              ...
              <div className="flex gap-4">
                  ...
                  <Button onClick={() => {}} className="flex-1 justify-center">
                      REVIEW
                  </Button>
              </div>
