...
const Confirmations = () => {
    ...
    const searchFilter = (array: any) => {
        return array.filter((el: any) => el["uid"].includes(search));
    };
    const sortBy = (array: any) => {
        return array.sort((el1: any, el2: any) => {
        ...
        <main className="flex min-h-screen flex-col items-center">
            ...
            <div className="adminTable">
                <div className="adminRow">
                    <div className="adminCell adminLabelX" key="uidlabel">
                        <strong>UID</strong>
                    </div>
                    <div className="adminCell adminLabelX" key="emaillabel">
                        <strong>EMAIL</strong>
                    </div>
                    <div className="adminCell" key="conflabel">
                        confirmed:
                    </div>
                </div>
                ...
                {sorted.map((inp: any) => (
                    <div className="adminRow" key={inp["uid"] + "row"}>
                        ...
                        <div
                            className={
                                period.includes(inp["lastConfirm"]) &&
                                inp["lastConfirm"]
                                    ? "adminCell adminCellG"
                                    : "adminCell adminCellR"
                            }
                            key={inp["uid"] + "confirmation"}
                        >
                            {inp["lastConfirm"]}
                        </div>
                    </div>
